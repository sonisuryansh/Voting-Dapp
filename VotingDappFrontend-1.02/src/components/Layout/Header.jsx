  ...
  return (
    <header className="bg-primary text-primary-foreground sticky top-0 z-50 shadow-lg">
      ...
      <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
        ...
        {/* Mobile Menu Button */}
        <button
          className="md:hidden p-2 rounded-md text-primary-foreground/70 hover:bg-primary-foreground/10 bg-transparent border-none cursor-pointer"
      ...
      {/* Mobile Navigation */}
      {mobileMenuOpen && (
        <nav className="md:hidden border-t border-primary-foreground/10" aria-label="Mobile navigation">
